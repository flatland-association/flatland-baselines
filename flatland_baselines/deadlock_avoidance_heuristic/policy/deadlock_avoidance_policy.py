...
from flatland_baselines.deadlock_avoidance_heuristic.observation.deadlock_avoidance_observations import DeadlockAvoidanceObservationBuilder, \
...
class DeadLockAvoidancePolicy(SetPathPolicy):
    def __init__(self,
        ...
        self.start_step_service: Optional[DeadlockAvoidanceObservationBuilderService] = None
    ...
    def _init_env(self, env: RailEnv):
        self.start_step_service = DeadlockAvoidanceObservationBuilderService(
